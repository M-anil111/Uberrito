...
<main id="content" class="nv-home">
  ...
  <section id="menu" class="nv-menu-section"><div class="nv-shell">
    ...
    <div class="nv-menu-proof" data-nv-reveal><span><i>♨</i><b>Made fresh daily</b><small>Never pre-cooked. Always fresh.</small></span><span><i>◉</i><b>Quality ingredients</b><small>Real ingredients. Real flavor.</small></span><span><i>✦</i><b>Made your way</b><small>Customize everything.</small></span></div>
  </div></section>
  ...
  <section class="nv-feels" aria-labelledby="nv-feels-title"><div class="nv-feels__wave"></div><div class="nv-shell nv-feels__stage">
    ...
    <div class="nv-burrito-pal" aria-label="A playful burrito character that follows your pointer"><span class="nv-burrito-arm nv-burrito-arm--left"></span><img src="<?php echo $asset( 'wrapped-burrito.png.webp' ); ?>" alt="" width="900" height="452"><span class="nv-character-eyes"><i class="nv-eye"><b></b></i><i class="nv-eye"><b></b></i></span><span class="nv-burrito-smile"></span><span class="nv-burrito-arm nv-burrito-arm--right"></span></div>
  </div></section>
  ...
  <section id="rewards" class="nv-reward-ribbon" aria-label="Uberrito rewards"><div class="nv-shell"><div><p>NÜ REWARDS</p><h2>EAT. EARN. <span>EAT FREE.</span></h2></div><a class="nv-face-button nv-face-button--small nv-magnetic" href="<?php echo esc_url( $rewards_url ); ?>"><span class="nv-eye"><i></i></span><span class="nv-eye"><i></i></span><b>JOIN<br>FREE</b></a></div></section>

  <section id="bottom-nav" class="nv-bottom-nav" aria-labelledby="nv-bottom-title"><div class="nv-bottom-preview" aria-hidden="true"><img src="<?php echo $asset( 'burrito.webp' ); ?>" alt=""></div><div class="nv-shell"><p class="nv-eyebrow">PICK YOUR NEXT MOVE</p><h2 id="nv-bottom-title" class="screen-reader-text">Explore Uberrito</h2><nav aria-label="Explore Uberrito"><a href="<?php echo esc_url( $order_url ); ?>" data-preview="burrito.webp"><span>01</span>Burritos <b>↗</b></a><a href="<?php echo esc_url( home_url( '/menu/' ) ); ?>" data-preview="Bowl-1.webp"><span>02</span>Menu <b>↗</b></a><a href="<?php echo esc_url( $rewards_url ); ?>" data-preview="rewards-burritos.webp"><span>03</span>Rewards <b>↗</b></a><a href="<?php echo esc_url( $catering_url ); ?>" data-preview="uberrito-loaded-nachos-wide.png"><span>04</span>Catering <b>↗</b></a><a href="<?php echo esc_url( $locations_url ); ?>" data-preview="uberrito-atascocita-exterior.jpeg"><span>05</span>Locations <b>↗</b></a></nav></div></section>
