...
function uberrito_new_home_plugin_assets() {
	...
	wp_enqueue_style(
		'uberrito-new-home-live-v240',
		$base_url . 'new-home-v240.css',
		array(),
		'2.4.0'
	);
...
function uberrito_new_home_filter_style_tag( $html, $handle ) {
	...
	$allowed = array( 'uberrito-new-home-live-v240', 'admin-bar', 'dashicons' );
...
function uberrito_new_home_filter_script_tag( $tag, $handle ) {
	...
	return 'uberrito-new-home-live-v240' === $handle ? $tag : '';
}
