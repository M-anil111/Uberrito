...
<main id="content" class="nv-home">
  ...
  <section id="merch" class="nv-merch" aria-labelledby="nv-merch-title"><div class="nv-shell nv-merch__layout">
    ...
    <div class="nv-merch__art nv-parallax" data-depth="14" data-nv-reveal><img class="nv-merch__collection" src="<?php echo $asset( 'merch-official.webp' ); ?>" alt="Official Uberrito merchandise" width="1024" height="1024" loading="lazy"><img class="nv-merch__cup" src="<?php echo $plugin_asset( 'uberrito-cup.png' ); ?>" alt="Uberrito Above and Beyond Burrito cup" width="511" height="1080" loading="lazy"><div>DROP<br><b>001</b></div><div class="nv-clippy nv-clippy--merch" aria-hidden="true"><span class="nv-clippy__bubble">Fresh fit. Zero boring merch.</span><span class="nv-clippy__hoodie"></span><img src="<?php echo $asset( 'wrapped-burrito.png.webp' ); ?>" alt=""><span class="nv-clippy__cap"></span><span class="nv-clippy__eyes"><i></i><i></i></span></div></div>
  </div></section>
